...
class JsonValue(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JsonValue:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JsonValue:
        """Create an instance of JsonValue from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JsonValue.parse_obj(obj)

        _obj = JsonValue.parse_obj({
