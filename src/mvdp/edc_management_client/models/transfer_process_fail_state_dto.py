...
class TransferProcessFailStateDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransferProcessFailStateDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransferProcessFailStateDto:
        """Create an instance of TransferProcessFailStateDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransferProcessFailStateDto.parse_obj(obj)

        _obj = TransferProcessFailStateDto.parse_obj({
