...
class DataService(BaseModel):
    ...
    __properties = ["endpointUrl", "id", "terms"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataService:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataService:
        """Create an instance of DataService from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataService.parse_obj(obj)

        _obj = DataService.parse_obj({
