...
class PolicyDefinitionRequestDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyDefinitionRequestDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PolicyDefinitionRequestDto:
        """Create an instance of PolicyDefinitionRequestDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyDefinitionRequestDto.parse_obj(obj)

        _obj = PolicyDefinitionRequestDto.parse_obj({
            "id": obj.get("@id"),
