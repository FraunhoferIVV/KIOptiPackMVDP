...
class Constraint(BaseModel):
    ...
    Constraint
    """
    edctype: StrictStr = Field(...)
    __properties = ["edctype"]
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Constraint:
        """Create an instance of Constraint from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Constraint.parse_obj(obj)

        _obj = Constraint.parse_obj({
            "edctype": obj.get("edctype")
        })
        return _obj
