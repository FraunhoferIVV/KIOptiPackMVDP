...
class PolicyDefinitionResponseDto(BaseModel):
    """
    ...
    policy: Policy = Field(...)
    __properties = ["@context", "@id", "@type", "createdAt", "policy"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PolicyDefinitionResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PolicyDefinitionResponseDto:
        """Create an instance of PolicyDefinitionResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PolicyDefinitionResponseDto.parse_obj(obj)

        _obj = PolicyDefinitionResponseDto.parse_obj({
