...
class NegotiationState(BaseModel):
    ...
    __properties = ["@context", "@type", "state"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NegotiationState:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NegotiationState:
        """Create an instance of NegotiationState from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NegotiationState.parse_obj(obj)

        _obj = NegotiationState.parse_obj({
