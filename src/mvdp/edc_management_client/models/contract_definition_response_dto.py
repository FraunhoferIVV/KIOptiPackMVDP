...
class ContractDefinitionResponseDto(BaseModel):
    """
    ...
    access_policy_id: Optional[StrictStr] = Field(None, alias="accessPolicyId")
    assets_selector: Optional[conlist(CriterionDto)] = Field(None, alias="assetsSelector")
    contract_policy_id: Optional[StrictStr] = Field(None, alias="contractPolicyId")
    created_at: Optional[StrictInt] = Field(None, alias="createdAt")
    __properties = ["@context", "@id", "@type", "accessPolicyId", "assetsSelector", "contractPolicyId", "createdAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContractDefinitionResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContractDefinitionResponseDto:
        """Create an instance of ContractDefinitionResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContractDefinitionResponseDto.parse_obj(obj)

        _obj = ContractDefinitionResponseDto.parse_obj({
