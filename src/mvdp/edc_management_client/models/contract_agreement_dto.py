...
class ContractAgreementDto(BaseModel):
    ...
    contract_signing_date: Optional[StrictInt] = Field(None, alias="contractSigningDate")
    policy: Policy = Field(...)
    provider_id: StrictStr = Field(..., alias="providerId")
    __properties = ["@context", "@id", "@type", "assetId", "consumerId", "contractSigningDate", "policy", "providerId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContractAgreementDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContractAgreementDto:
        """Create an instance of ContractAgreementDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContractAgreementDto.parse_obj(obj)

        _obj = ContractAgreementDto.parse_obj({
            "context": obj.get("@context"),
            "id": obj.get("@id"),
            "type": obj.get("@type"),
            "asset_id": obj.get("assetId"),
            "consumer_id": obj.get("consumerId"),
            "contract_signing_date": obj.get("contractSigningDate"),
