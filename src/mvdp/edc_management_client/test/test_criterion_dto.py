...
from mvdp.edc_management_client.models.criterion_dto import CriterionDto  # noqa: E501
from mvdp.edc_management_client.rest import ApiException

class TestCriterionDto(unittest.TestCase):
    """CriterionDto unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `CriterionDto`
        """
        model = mvdp.edc_management_client.models.criterion_dto.CriterionDto()  # noqa: E501
        if include_optional :
            return CriterionDto(
