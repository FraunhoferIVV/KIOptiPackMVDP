...
from mvdp.edc_management_client.models.policy import Policy  # noqa: E501
...
class TestPolicy(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = mvdp.edc_management_client.models.policy.Policy()  # noqa: E501
        if include_optional :
            return Policy(
                type = 'SET', 
                assignee = '', 
                ...
                permissions = [
                    mvdp.edc_management_client.models.permission.Permission(
                        action = mvdp.edc_management_client.models.action.Action(
                            constraint = mvdp.edc_management_client.models.constraint.Constraint(
                                edctype = '', ), 
                            included_in = '', 
