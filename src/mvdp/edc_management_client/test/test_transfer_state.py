...
from mvdp.edc_management_client.models.transfer_state import TransferState  # noqa: E501
...
class TestTransferState(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `TransferState`
        """
        model = mvdp.edc_management_client.models.transfer_state.TransferState()  # noqa: E501
        if include_optional :
